...
## Overview
- **Chain upgrade point**: TBD, at height `7147000`
...
## Upgrade Details
The upgrade will take place at height `7147000` on the Xion testnet.
...
3. **Wait for upgrade height**: Run until upgrade height 7147000, the node will panic.
...
```bash
xiond start --unsafe-skip-upgrade 7147000
```
