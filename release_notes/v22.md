...
- **Upgrade Height**: [7216000](https://www.mintscan.io/{{MINTSCAN_CHAIN_ID}}/blocks/7216000) (yoshimitsu-network-wowowowowowow)
- **Proposal Number**: [038](https://www.mintscan.io/{{MINTSCAN_CHAIN_ID}}/proposals/038)
- **Upgrade Name**: [v22](https://github.com/burnt-labs/yoshimitsu-network-wowowowowowow/blob/main/proposals/038-upgrade-v22.json)
...
For more information about the upgrade process, please refer to the [upgrade proposal](../proposals/038-upgrade-v22.json).
