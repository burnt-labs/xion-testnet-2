...
The Xion v26 release introduces two new modules (DKIM and ZK) for blockchain-based email authentication with zero-knowledge proofs, along with critical security fixes to existing modules. This is a release candidate version (v26.0.0-rc1) for testing on testnet before the final production release.
