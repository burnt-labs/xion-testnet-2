...
- **Upgrade Height**: `7115000` (estimated: ~2 days from current block)
...
### Upgrade Process
1. **Wait** for upgrade height `7115000`
...
xiond start --unsafe-skip-upgrade 7115000
```
...
**🔄 Run Details**: 
- Workflow run: 49
- Commit: 8d5169fbdeae870353947fc80c29f4141e5a9e92
- Timestamp: 2025-09-02 12:52:16 UTC
